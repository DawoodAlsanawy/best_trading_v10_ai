...
class Config:
    ...
    BASE_RISK: float = 0.90       
    MIN_RISK:  float = 0.50       
    MAX_RISK:  float = 0.99       # أقصى مخاطرة 5% لحماية الجسيم الصغير
    ...
    CAPITAL_FLOOR: float = 0.05    # قوة التنافر اللانهائية (نقطة استحالة التصفية)
    ...
    PO_MAX_WAIT_S: int = 300             # entry wait time
